...
export class Rendering {
  constructor(canvas, usePostProcess = false) {
    ...
    this.camera = new THREE.OrthographicCamera(-size * ratio*4, size * ratio*4,size * ratioW*4 ,-size  * ratioW *4, 0.001, 1000)
    ...
    if(usePostProcess){
      ...
      // console.log(normalPass.renderPass.overrideMaterialManager)
